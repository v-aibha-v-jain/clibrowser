...
document.addEventListener("DOMContentLoaded", () => {
  ...
  toggle.addEventListener("change", (e) => {
    if (e.target.checked)
      document.documentElement.classList.add("bubble-enabled");
    else document.documentElement.classList.remove("bubble-enabled");
  });
  ...
  function handleCommand(cmd) {
    ...
    switch (c.toLowerCase()) {
      case "help":
        appendLine(
          "Commands: help — show this, clear — clear output, ping — pong"
        );
        break;
      case "clear":
        output.innerHTML = "";
      ...
      case "ping":
        ...
        break;
      default:
        appendLine(`Command not found: ${c}`);
    }
  }
